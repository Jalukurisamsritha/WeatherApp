...
//             <p className="card-text">Pressure: {weatherData.main.pressure}mb</p>
//             <img
...
//             <h3 className="card-title">{forecast.weekday}</h3>
//             <p className="card-text">Date: {forecast.date}</p>
//             <p className="card-text">Min Temp: {Math.round(forecast.minTemp - 273.15)}°C</p>
//             <p className="card-text">Max Temp: {Math.round(forecast.maxTemp - 273.15)}°C</p>
//             <img
//               className="weather-icon"
    ...
    <div className="weather-forecast-container">
      ...
      {weatherData && (
        <div className="weather-data">
          ...
          <div className='todayIcon'>
          <img className="iconi" src={`https://openweathermap.org/img/w/${weatherData.weather[0].icon}.png`} alt="Weather Icon" />
          </div>
        </div>
      )}
      <hr />
      <div className="forecast-container">
        {forecastData.map((forecast) => (
          <div key={forecast.date} className="forecast-item">
            ...
            <p className="description">Description: {forecast.description}</p>
            <div className="icon-container">
              <img className="iconi" src={`https://openweathermap.org/img/w/${forecast.icon}.png`} alt="Weather Icon" />
            </div>
            {/* <p className="weekday">Day: {forecast.weekday}</p> */}
          </div>
        ))}
